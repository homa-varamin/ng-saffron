import {SaffronInputService} from "./saffron-input.service";

export class SaffronInputHandler {

    private inputService: SaffronInputService;
    private onModelChange!: Function;
    private onModelTouched!: Function;

    constructor(htmlInputElement: HTMLInputElement, options: any) {
        this.inputService = new SaffronInputService(htmlInputElement, options);
    }
