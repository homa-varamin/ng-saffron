import { SaffronInputManager } from "./saffron-input.manager";
import { CurrencyMaskConfig, CurrencyMaskInputMode } from "./saffron-currency-mask.config";

export class SaffronInputService {
    ...
    inputManager: SaffronInputManager;

    constructor(private htmlInputElement: any, private options: CurrencyMaskConfig) {
        this.inputManager = new SaffronInputManager(htmlInputElement);
        this.initialize()
    }
