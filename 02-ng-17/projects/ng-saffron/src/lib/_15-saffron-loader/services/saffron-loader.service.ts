import { SaffronLoaderComponent } from '../saffron-loader.component';
import { Injectable, ViewContainerRef } from '@angular/core';

@Injectable({ providedIn: 'root' })
export class SaffronLoaderService {
  ...
  public setRootViewContainerRef(rootViewContainerRef: ViewContainerRef) {
    if (!SaffronLoaderService.rootViewContainerRef) {
      SaffronLoaderService.rootViewContainerRef = rootViewContainerRef;
    }
  }
  ...
  private injectLoaderToDom(): void {
    if (!this.isInjected) {
      SaffronLoaderService.rootViewContainerRef.createComponent(
